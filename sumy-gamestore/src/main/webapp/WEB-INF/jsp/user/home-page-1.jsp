...
<head>
<!-- Title -->
<title>sumy gamestore - main page</title>
...
<!-- Revolution Slider -->
<link rel="stylesheet"
	href="/resources/static/assets/vendor/revolution-slider/revolution/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css">
<link rel="stylesheet"
	href="/resources/static/assets/vendor/revolution-slider/revolution/css/settings.css">
<link rel="stylesheet"
	href="/resources/static/assets/vendor/revolution-slider/revolution/css/layers.css">
<link rel="stylesheet"
	href="/resources/static/assets/vendor/revolution-slider/revolution/css/navigation.css">
<link rel="stylesheet"
	href="/resources/static/assets/vendor/revolution-slider/revolution-addons/typewriter/css/typewriter.css">
...
<body>
	...
	<main class="g-pt-80">
				...
				<div id="rev_slider_1014_1" class="rev_slider fullscreenbanner"
					...
					<ul>
						...
						<li data-index="rs-2800"
							...
							data-thumb="/resources/static/user/assets/img-temp/1920x1080/img2.jpg"
							...
							<!-- MAIN IMAGE --> <img
							src="/resources/static/user/assets/img/banner/egs-mars-horizons-breaker.jpg"
							...
							<div class="tp-caption   tp-resizeme" id="slide-2800-layer-1"
								...
								data-lineheight="['110','110','100','60']" data-width="none"
							...
							<div class="tp-caption   tp-resizeme" id="slide-2800-layer-2"
								...
								data-type="text"
								data-typewriter='{"lines":"#Simulation%20%20#Strategy%20#Indie%20%20%20%20","enabled":"on","speed":"70","delays":"1%7C100","looped":"on","cursorType":"one","blinking":"on","word_delay":"off","sequenced":"on","hide_cursor":"off","start_delay":"1500","newline_delay":"1000","deletion_speed":"20","deletion_delay":"1000","blinking_speed":"500","linebreak_delay":"60","cursor_type":"two","background":"off"}'
								data-responsive_offset="on"
								data-frames='[{"from":"y:50px;sX:1;sY:1;opacity:0;","speed":2500,"to":"o:1;","delay":500,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
								data-textAlign="['center','center','center','center']"
								data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
								data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
								style="z-index: 8; min-width: 640px; max-width: 640px; white-space: nowrap; font-size: 30px; line-height: 40px; font-weight: 400; color: rgba(255, 255, 255, 1.00); border-width: 0px;">
								인류를 화성으로 대형 우주 기관을 운영하세요.</div>
						</li>
						<!-- END SLIDE  -->

						<!-- SLIDE  -->
						<li data-index="rs-2802"
							data-transition="slidingoverlayhorizontal"
							data-slotamount="default" data-hideafterloop="0"
							data-hideslideonmobile="off" data-easein="default"
							data-easeout="default" data-masterspeed="default"
							data-thumb="/resources/static/user/assets/img-temp/1920x1080/img1.jpg"
							data-rotate="0" data-saveperformance="off" data-title="Slide"
							data-param1="" data-param2="" data-param3="" data-param4=""
							data-param5="" data-param6="" data-param7="" data-param8=""
							data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE --> <img
							src="/resources/static/user/assets/img/banner/17br-cosmic-summer.jpg"
							alt="" data-bgposition="center center" data-bgfit="cover"
							...
							<div class="tp-caption   tp-resizeme" id="slide-2802-layer-1"
								...
								Enjoy our Summer-Season Games</div>
						</li>
						<!-- END SLIDE  -->
						...
						<li data-index="rs-2801"
							...
							data-hideslideonmobile="off" data-easein="default"
							data-easeout="default" data-masterspeed="default"
							data-thumb="/resources/static/user/assets/img-temp/1920x1080/img3.jpg"
							data-rotate="0" data-saveperformance="off" data-title="Slide"
							data-param1="" data-param2="" data-param3="" data-param4=""
							data-param5="" data-param6="" data-param7="" data-param8=""
							data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE --> <img
							src="/resources/static/user/assets/img/banner/egs-social-horizonzerodawn.jpg"
							alt="" data-bgposition="center center" data-bgfit="cover"
							data-bgrepeat="no-repeat" class="rev-slidebg"> <!-- LAYERS -->
							...
							<div class="tp-caption   tp-resizeme" id="slide-2801-layer-1"
								...
								Horizon Zero Dawn™</div> <!-- LAYER NR. 10 -->
							<div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme"
								id="slide-2801-layer-3"
								data-x="['center','center','center','center']"
								data-hoffset="['0','0','0','0']"
								data-y="['middle','middle','middle','middle']"
								data-voffset="['-50','-50','-54','-89']" data-width="60"
								...
								data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
								data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
								style="z-index: 14; border-color: rgba(0, 0, 0, 0); border-width: 0px;">
							</div> <!-- LAYER NR. 11 -->
							<div class="tp-caption   tp-resizeme" id="slide-2801-layer-2"
								...
								data-typewriter='{"lines":"#Action%20#RPG%20#Adventure%20,","enabled":"on","speed":"60","delays":"1%7C100","looped":"on","cursorType":"one","blinking":"on","word_delay":"off","sequenced":"on","hide_cursor":"off","start_delay":"1500","newline_delay":"1000","deletion_speed":"20","deletion_delay":"1000","blinking_speed":"500","linebreak_delay":"60","cursor_type":"two","background":"off"}'
								data-responsive_offset="on"
								data-frames='[{"from":"y:50px;sX:1;sY:1;opacity:0;","speed":2500,"to":"o:1;","delay":500,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
								data-textAlign="['center','center','center','center']"
								data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
								...
								기계들이 정복한 미래의 지구에서 미스터리를 풀어나가는 Aloy의 전설적인 여정을 경험하세요.</div>
						</li>
						<!-- END SLIDE  -->
					</ul>
		...
		<div class="container g-pt-100 g-pb-70">
			<div class="text-center mx-auto g-max-width-600 g-mb-50">
				<span class="u-icon-v1 g-color-pink g-mr-15 g-mb-15"> <i
					class="icon-education-007 u-line-icon-pro"></i>
				</span>
				<h2 class="g-color-black mb-4">Sumy News</h2>
				<p class="lead">Sumy Game Shop에서 최근에 어떤 일이 있었냐 하면요!</p>
			</div>
		...
		<!-- Products -->
		<div
			class="container g-brd-around g-brd-gray-light-v3 g-bg-white rounded g-px-55 g-py-50 g-mb-70">
			<div class="text-center mx-auto g-max-width-600 g-mb-50">
				<h2 class="g-color-black mb-4">
					<span class="u-icon-v1 g-color-orange g-pb-15"> <i
						class="icon-education-036 u-line-icon-pro"></i>
					</span> 무료 게임 <span class="u-icon-v1 g-color-orange g-pb-15"> <i
						class="icon-education-036 u-line-icon-pro"></i>
					</span>
				</h2>
				<p class="lead">Sumy Game Shop에서 제공하는 무료 게임을 즐겨보세요!!</p>
			</div>

			<div id="carouselCus1" class="js-carousel g-pb-100 g-mx-minus-10"
				data-infinite="true" data-slides-show="4" data-lazy-load="ondemand"
		...
		<div class="container g-pb-100">
			<div class="text-center mx-auto g-max-width-600 g-mb-50">
				<h2 class="g-color-black mb-4">
					<span class="u-icon-v1 g-color-red g-pb-15"> <i
						class="icon-christmas-017 u-line-icon-pro"></i>
					</span> 할인 상품 <span class="u-icon-v1 g-color-red g-pb-15"> <i
						class="icon-christmas-017 u-line-icon-pro"></i>
					</span>
				</h2>
				<p class="lead">지금 할인중인 다양한 게임들을 합리적인 가격에 만나보세요!</p>
			</div>
		...
		<section class="container g-pb-70">
			<div class="text-center mx-auto g-max-width-600 g-mb-50">
				<h2 class="g-color-black mb-4">
					<i class="icon-christmas-079 u-line-icon-pro"></i> 신규 및 인기작 <i
						class="icon-christmas-079 u-line-icon-pro"></i>
				</h2>
			</div>

			<div
				class="row g-mx-minus-10 g-brd-around g-mb-50 g-brd-gray-light-v3 g-bg-white rounded">
		...
		<!-- Categories -->
		<div class="container-fluid px-0 g-pb-100">
			<div class="row align-items-center no-gutters">
				<div
					class="col-md-7 col-lg-8 u-block-hover g-bg-size-cover g-min-height-500 g-flex-centered"
					data-bg-img-src="/resources/static/user/assets/img/banner/egs-amongus.jpg">
					<div class="g-flex-centered-item text-right g-pa-50">
						<h2
							...
							We'll give you <br> a special present
						</h2>
						<span
							class="u-link-v5 g-color-black g-color-primary--hover g-font-size-18">지금
							보러가기</span>
					</div>
				...
				<div
					...
					data-bg-img-src="/resources/static/user/assets/img/bg/secondary.png">
					<div class="g-pt-50 g-pr-50 g-pb-50 g-pl-50">
						<h3
							class="h1 u-link-v5 g-color-black g-font-weight-700 g-font-weight-400 mb-3">Among
							Us</h3>
						<h4 class="h3 g-color-gray-dark-v5 g-font-weight-400 mb-4">온라인
		...
		<div class="container g-pb-100">
			<div class="text-center mx-auto g-max-width-600 g-mb-50">
				<h2 class="g-color-black mb-4">
					<span class="u-icon-v1 g-color-blue g-pb-15"> <i
						class="icon-christmas-037 u-line-icon-pro"></i>
					</span> 최고 인기작 <span class="u-icon-v1 g-color-blue g-pb-15"> <i
						class="icon-christmas-037 u-line-icon-pro"></i>
					</span>
				</h2>
				<p class="lead">Sumy Game Shop에서 사용자들에게 가장 인기 만점인 게임들을 만나보세요!!</p>
			</div>
		...
		<div id="modal-type-onscroll"
			class="js-autonomous-popup text-left g-bg-white g-pos-rel g-rounded-5"
			style="display: none;" data-modal-type="onscroll"
			data-open-effect="fadeIn" data-close-effect="fadeIn"
			...
			<div class="g-width-720">
				<div class="row align-items-center">
					<div
						class="col-sm-6 g-height-350--sm g-bg-size-cover g-bg-pos-top-center g-rounded-left-5"
						data-bg-img-src="/resources/static/user/assets/img-temp/300x300/img1.jpg"></div>
					...
					<div class="col-sm-6">
						<div class="g-pl-30 g-pl-20--sm g-pr-30 g-py-20">
							...
							<div class="g-mb-35">
								...
								<p class="g-font-weight-300 g-font-size-16">Get free
									promotions every month!</p>
							</div>
							<!-- End Info -->
							...
							<form class="input-group u-shadow-v19 rounded g-mb-20">
								<input
									...
									<button
										class="btn u-btn-primary rounded text-uppercase g-py-8 g-px-18"
										type="submit">
							...
							<ul class="list-inline mb-0">
								<li class="list-inline-item g-mx-0"><a
									class="u-icon-v3 u-icon-size--xs g-color-main-light-v3 g-color-white--hover g-bg-white g-bg-primary--hover g-font-size-13 rounded"
	...
	<script
		src="/resources/static/assets/vendor/slick-carousel/slick/slick.js"></script>
	<script
	...
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/jquery.themepunch.tools.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/jquery.themepunch.revolution.min.js"></script>

	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution-addons/typewriter/js/revolution.addon.typewriter.min.js"></script>

	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.actions.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.migration.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
	<script
		src="/resources/static/assets/vendor/revolution-slider/revolution/js/extensions/revolution.extension.video.min.js"></script>
