  ...
  <main>
    ...
    <!-- sidebar 끝 -->
        ...
        <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
          ...
          <div class="g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">뉴스 수정</span>
              </li>
            </ul>
          </div>
          <!-- End Breadcrumb-v1 -->
          ...
          <!-- 컨텐츠 시작 -->
          <div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">뉴스 수정</h1>
    ...
    <script src="/resources/static/admin/js/admin-news-add.js"></script>
