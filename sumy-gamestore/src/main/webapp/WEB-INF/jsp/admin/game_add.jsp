...
<head>
<!-- Title -->
<title>Sumy GameStore 게임 추가</title>
...
<link rel="stylesheet"
	href="/resources/static/assets/vendor/icon-etlinefont/style.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="/resources/static/admin/assets/vendor/hs-admin-icons/hs-admin-icons.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="/resources/static/admin/assets/vendor/bootstrap-select/css/bootstrap-select.min.css">
<link rel="stylesheet"
	href="/resources/static/admin/assets/vendor/chartist-js/chartist.min.css">
<link rel="stylesheet"
	href="/resources/static/admin/assets/vendor/fancybox/jquery.fancybox.min.css">
...
<!-- CSS Unify -->
<link rel="stylesheet"
	href="/resources/static/admin/assets/css/unify-admin.css">
...
<body>
	<main>
		...
		<div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
			...
			<div class="g-bg-gray-light-v8 g-pa-20">
				<ul class="u-list-inline g-color-gray-dark-v6">
					...
					<li class="list-inline-item g-mr-10"><a id="pageName"
						class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle"
						href="/admin/game/list">게임 관리</a> <i
					...
					<li class="list-inline-item g-mr-10"><a
						class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle"
						href="${pageContext.request.contextPath }/admin/game/list">게임
							리스트</a> <i
						class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
					</li>

					<li class="list-inline-item"><span class="g-valign-middle">게임
							추가</span></li>
				</ul>
			</div>
			<!-- End Breadcrumb-v1 -->
			...
			<!-- 컨텐츠 시작 -->
			<div class="g-pa-20">
				<h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">게임
					추가</h1>
				...
				<div class="container">
						...
						<div
							...
							<div class="g-mb-30">
								...
								<div class="form-group g-pos-rel">
									<span
										...
										<i
										class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
									</span> <input id="gameId" type="hidden" value="${gameInfo.gameId }">
									<input id="gameTitle"
							...
							<div class="g-mb-30">
								...
								<div
									...
									<select id="gameRate"
										class="js-select u-select--v3-select u-sibling w-100 g-pl-0--child"
										required="required" title="게임 등급 선택" style="display: none;">
										<option value="전체"
							...
							<!-- 이미지 썸네일 시작 -->
							<div
								class="row justify-content-center g-mb-30 g-bg-gray-light-v9 rounded-0 g-mx-0">
								<img id="preview-image" class="img-fluid g-height-300"
							...
							<!-- 이미지 선택 시작 -->
							<div
								class="form-group mb-20 g-brd-bottom g-brd-gray-light-v7 rounded-0">
								<label class="u-file-attach-v2 g-color-gray-dark-v5 mb-0">
									<form id="fileForm" enctype="multipart/form-data">
										<input id="fileAttachment" name="thumbnail" type="file"
							...
							<div class="g-mt-30 g-mb-30">
								...
								<div class="form-group g-pos-rel input-group">
									<span
										...
										<i
										class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
									</span> <input id="sumy-game-input-price"
										class="form-control form-control-md g-brd-none g-brd-bottom g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 px-0 g-py-10"
										type="text" maxlength="8" style="text-align: right"
										oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="input-group-append">
										<span
											class="input-group-text rounded-0 g-color-gray-dark-v5 g-brd-none">원</span>
									</div>
								</div>
							</div>
							<!-- 게임 가격 끝 -->
							...
							<div class="g-mt-30 g-mb-30">
								...
								<div class="form-group g-pos-rel input-group">
									<span
										...
										<i
										class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
									</span> <input id="sumy-game-discount-rate"
										class="form-control form-control-md g-brd-none g-brd-bottom g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 px-0 g-py-10"
										type="text" style="text-align: right"
										oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="input-group-append">
										<span
											class="input-group-text rounded-0 g-color-gray-dark-v5 g-brd-none">%</span>
									</div>
								</div>
							</div>
							<!-- 할인율 끝 -->
							...
							<div class="g-mt-30 g-mb-30">
								...
								<div class="form-group g-pos-rel input-group">
									<span
										...
										<i
										class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
									</span> <input id="sumy-game-result-price"
							...
							<div class="g-mt-30 g-mb-30">
								...
								<div class="form-group g-pos-rel">
									...
									<textarea id="gameSubText"
										...
										type="text" placeholder="게임설명을 입력해주세요." rows="4"
					...
					<div class="">
						...
						<div
							...
							<div class="g-bg-gray-light-v9 rounded-0 g-mb-30">
								<div class="row justify-content-center">
									<img id="preview-image-0" class="col-4 g-py-5" height="300px"
										src="/upload/default_img.jpg"> <img id="preview-image-1"
										class="col-4 g-py-5" height="300px"
										src="/upload/default_img.jpg">
								</div>
								<div class="row justify-content-center">
									<img id="preview-image-2" class="col-4 g-py-5" height="300px"
										src="/upload/default_img.jpg"> <img id="preview-image-3"
										class="col-4 g-py-5" height="300px"
										src="/upload/default_img.jpg"> <img id="preview-image-4"
										class="col-4 g-py-5" height="300px"
										src="/upload/default_img.jpg">
								</div>
							</div>
							...
							<!-- 이미지 선택 시작 -->
							<div
								class="form-group mb-20 g-brd-bottom g-brd-gray-light-v7 rounded-0 g-mb-30">
								<label class="u-file-attach-v2 g-color-gray-dark-v5 mb-0">
									<form>
										<input id="input-multiple-image" name="files" type="file"
											accept=".gif,.jpg,.jpeg,.png" multiple>
									</form> <i
									class="icon-cloud-upload g-font-size-16 g-pos-rel g-top-2 g-mr-5"></i>
									<span id="imgExplainMulti" class="js-value">이미지 파일을
										첨부해주세요.</span>
								</label>
							</div>
							<!-- 이미지 선택 끝 -->
				...
				<div class="justify-content-center row align-items-center">
					<a href="${pageContext.request.contextPath }/admin/game/list"
						class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-mr-10 g-font-size-14"
						data-dismiss="modal">돌아가기</a> <a id="btn-game-add-parent" href="#"
						class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-mr-10 g-font-size-14"
						data-toggle="modal" data-dismiss="modal">추가</a>
				</div>
		...
		<div class="align-items-center g-line-height-1 justify-content-center">
			...
			<!-- 게임 추가 모달 내용 시작 -->
			<div class="modal fade justify-content-center" id="exampleModal"
				tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog  modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-body">
							<div class="row justify-content-center g-mx-5">
								<div class="col-12 g-mt-10 g-mb-30">게임을 추가 하시겠습니까?</div>
								<div>
									<a id="btn-game-add" href=""
										class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-mr-10 g-font-size-14"
										data-toggle="modal" data-dismiss="modal">추가</a> <a href="#"
										class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-mr-10 g-font-size-14"
			...
			<!-- 추가 완료 팝업 시작-->
			<div class="modal fade justify-content-center" id="exampleModal2"
				tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-body">
							<div class="row justify-content-center g-mx-5">
								<div class="col-12 g-mt-10 g-mb-30">게임 추가를 완료하였습니다.</div>
								<div>
									<a href="/admin/game/list"
										class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-font-size-14">확인</a>
								</div>
							</div>
						</div>
					</div>
	...
	<script
		src="/resources/static/admin/assets/vendor/jquery/jquery.min.js"></script>
	<script
		src="/resources/static/admin/assets/vendor/jquery-migrate/jquery-migrate.min.js"></script>
	...
	<script
		src="/resources/static/admin/assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
	<script
		src="/resources/static/assets/vendor/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
	<script
		src="/resources/static/admin/assets/vendor/chartist-js/chartist.min.js"></script>
	<script
		src="/resources/static/admin/assets/vendor/fancybox/jquery.fancybox.min.js"></script>
	<script
	...
	<script
		src="/resources/static/assets/vendor/jquery.maskedinput/src/jquery.maskedinput.js"></script>


	<!-- JS Unify -->
	<script src="/resources/static/assets/js/hs.core.js"></script>
	<script
		src="/resources/static/admin/assets/js/components/hs.side-nav.js"></script>
	...
	<script
		src="/resources/static/admin/assets/js/components/hs.bar-chart.js"></script>
	...
	<script src="/resources/static/js/admin/admin-game-add.js"></script>
</body>
